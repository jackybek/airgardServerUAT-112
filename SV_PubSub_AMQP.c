...
addWriterGroup(UA_Server *uaServer)
{
    ...
    if(useJson)
    {
	printf("addWriterGroup : useJson = UA_TRUE \n");
...
#endif
    {
	printf("addWriterGroup : useJson = UA_FALSE \n");
...
// line 1002
	*/
    ...
    if(useJson)
    {
	printf("addDataSetWriter : useJson = UA_TRUE \n");
...
// added by Jacky by comparing the code with addDataSetWriter()
        ...
        if(useJson)
        {
                printf("addDataSetReader : useJson = UA_TRUE \n");
...
*/
    ...
    if(useJson)
    {
	printf("addedReaderGroup : useJson = UA_TRUE \n");
...
#endif
    {
	printf("addedReaderGroup : useJson = UA_FALSE \n");
...
//******************************//
    ...
    if (MQTT_Enable==UA_TRUE && rv == UA_STATUSCODE_GOOD)
    {
	printf("***************\n");
    ...
    else if (AMQP_Enable==UA_TRUE && rv == UA_STATUSCODE_GOOD)
    {
        printf("***************\n");
